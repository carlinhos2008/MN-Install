...
wget "https://github.com/carlinhos2008/MSC_MASTER_2021/releases/download/1.0.0/masterstakecoin-daemon-linux.tar.gz" -O masterstakecoin-daemon-linux.tar.gz

wget "https://github.com/carlinhos2008/MSC_MASTER_2021/releases/download/1.0.0/masterstakecoin-qt-linux.tar.gz" -O masterstakecoin-qt-linux.tar.gz

Extract the tar files.

tar -xzvf masterstakecoin-daemon-linux.tar.gz

tar -xzvf masterstakecoin-qt-linux.tar.gz

Install the daemon and tools.

sudo mv masterstakecoind masterstakecoin-cli masterstakecoin-tx /usr/bin/

Create the config file.

mkdir $HOME/.masterstakecoin

nano $HOME/.masterstakecoin/masterstakecoin.conf

Paste the following lines in examplecoin.conf.

rpcuser=rpc_masterstakecoin
...
masterstakecoin-cli mnsync status
